...
public class NoomText extends TextView {
	public static final String TAG = "NoomText";

	private NoomBitmap background;

	public NoomText(Context context) {
		this(context, null);
	}

	public NoomText(Context context, AttributeSet attrs) {
		super(context, attrs);
	}
	...
	public void onFinishTemporaryDetach() {
		...
		Log.d(TAG, "onFinishTemporaryDetach " + this);
	}
